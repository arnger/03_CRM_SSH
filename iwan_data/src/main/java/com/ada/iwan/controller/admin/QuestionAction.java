...
public class QuestionAction {
	...
	public String list(Pageable pageable, HttpServletRequest request, ModelMap model) {
		...
		Page<Question> pagination = manager.findPage(pageable);
	...
	public String save(Question bean, HttpServletRequest request, ModelMap model) {
	...
	public String update(Pageable pageable, Question bean,HttpServletRequest request, ModelMap model) {
		bean = manager.update(bean);
		log.info("update Teacher id={}.", bean.getId());
		return "redirect:/admin/question/view_list.htm?pageNumber="+pageable.getPageNumber();
	}
